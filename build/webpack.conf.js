    ...
    module: {
        rules: [
            ...
            },
            {
                ...
                use: ExtractTextPlugin.extract({
                    fallback: 'style-loader',
                    use: ['css-loader', 'clean-css-loader', 'postcss-loader', 'less-loader']
                })
            }
        ]
    },
...
if (process.env.NODE_ENV === ENV_PRODUCTION || process.env.NODE_ENV === ENV_ALPHA || process.env.NODE_ENV === ENV_TEST || process.env.NODE_ENV === ENV_BETA) {
